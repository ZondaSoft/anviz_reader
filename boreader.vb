...
Friend Class boreader
    ...
    Private Sub Form1_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        Try
            myXmlDocument.Load("boreader2016.xml")
    ...
    Private Sub BtnGenerarTXT_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnGenerarTXT.Click
        ...
        Select Case cmbId.Text
            ...
            Case 3
                FILE_NAME = "C:\Zonda\zexporta_3"
                FILE_NAME2 = "C:\Zonda\zexporta_3_Ok"   'Salta Petroandina
            Case 12290478
                FILE_NAME = "C:\Zonda\zexporta_12290478"
                FILE_NAME2 = "C:\Zonda\zexporta_12290478_Ok"   'Metan Petroandina
            Case 12290497
                FILE_NAME = "C:\Zonda\zexporta_12290497"
                FILE_NAME2 = "C:\Zonda\zexporta_12290497_Ok"   ' Guemes Saltapetrol
        End Select
                ...
                Do While True
                    ...
                    If (Ret <> 0) Then
                        ...
                        For i = 1 To RetCount   ' RetCount
                            ...
                            lblUltima.Text = "Leyendo " & nRegistro & " registros de " & RecordCount & "  " & pClockings
                            Notify_icon.Text = "Leyendo " & nRegistro & " registros de " & RecordCount & "  " & pClockings

                            'lblUltima.Refresh()  ' Ver acabo de sacarlo
                            ...
                            If i >= txtInicio1.Text Then
                                ...
                                End If
                            Else
                                cFichada = Encoding.Default.GetString(clocking.Time) ' & "      " & clocking.Stat & "    " & _
    ...
    Private Sub cmbId_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbId.SelectedIndexChanged
        Select cmbId.Text
            ...
            Case 55555554
                txtIp.Text = "10.0.0.240"
            Case 1
                txtIp.Text = "10.0.1.218"   ' UCC
            Case 76130011
                txtIp.Text = "10.0.0.31"
            Case 76120114
                txtIp.Text = "10.0.0.32"
            Case 3
                txtIp.Text = "192.168.0.210"    'Salta Petroandina
            Case 12290478
                txtIp.Text = "petro-metan.dyndns.tv" 'Metan Petroandina
            Case 12290497
                txtIp.Text = "saltapetrol-noip.biz" ' Guemes Saltapetrol
        End Select
    End Sub
    ...
    Private Sub cmbId2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbId2.SelectedIndexChanged
        Select Case cmbId2.Text
            ...
            Case 76130011
                txtIp2.Text = "10.0.0.31"
            Case 76120114
                txtIp2.Text = "10.0.0.32"   ' Agrotecnica Relleno
            Case 3
                txtIp2.Text = "192.168.0.210"    'Salta Petroandina
            Case 12290478
                txtIp2.Text = "petro-metan.dyndns.tv" 'Metan Petroandina
            Case 12290497
                txtIp2.Text = "saltapetrol-noip.biz" ' Guemes Saltapetrol
        End Select
    End Sub
    ...
    Private Sub lblArchivo1_Click(sender As System.Object, e As System.EventArgs) Handles lblArchivo1.Click
    ...
    Private Sub RadioNet2_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles RadioNet2.CheckedChanged
        lblComPort2.Enabled = False
        cmbComPort2.Enabled = False

        lblIp2.Enabled = True
        txtIp2.Enabled = True
    End Sub

    Private Sub RadioCom2_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles RadioCom2.CheckedChanged
        lblComPort2.Enabled = True
        cmbComPort2.Enabled = True
